...
**Core Directive:**
When generating or modifying files, you must produce two distinct outputs: the **Primary Data File** and a **Metadata Sidecar (.meta.json)**. This enables precision retrieval without loading the entire document into context.
